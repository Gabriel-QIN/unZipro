...
>1. Predicts beneficial amino acid substitutions directly from structure
>2. Ranks variants based on learned fitness landscape
>3. Works in zero-shot mode — no supervised fine-tuning required
